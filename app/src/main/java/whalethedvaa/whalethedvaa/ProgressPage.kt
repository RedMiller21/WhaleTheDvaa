...
class ProgressPage : AppCompatActivity() {
    ...
    var medFlags = arrayOf("H0N3YB33", "N1C3-W4N", "F1SHF00D", "C4PTB1RD23Y3") //Flags for medium
    var killerFlags = arrayOf("C4SC4D1NG", "4M4Z1NG", "T4STY-K3LP", "WH413L0RD") //Flags for killer
